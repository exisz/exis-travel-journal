const WORLD_MODULE_PROTOCOL_VERSION = 1;
const WORLD_MODULE_REFERENCE_MIME = "application/x-world-module-reference";
...
window.WorldModuleSdk = { world, WORLD_MODULE_PROTOCOL_VERSION, WORLD_MODULE_REFERENCE_MIME };
